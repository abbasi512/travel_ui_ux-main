...
export const NAV_LINKS = [
  ...
  { href: '/', key: 'how_triptrek_work', label: 'How TripTrek Work?' },
...
export const FEATURES = [
  ...
  },
  {
    ...
    variant: 'green',
    description:
      "Schedule an adventure with friends. On holidays, there are many interesting offers from TripTrek. That way, there's no more discussion",
  },
  {
...
export const FOOTER_LINKS = [
  ...
  {
    title: 'Our Community',
    links: ['Climbing xixixi', 'Hiking triptrek', 'TripTrek kinthill'],
  },
];
...
export const FOOTER_CONTACT_INFO = {
  ...
  links: [
    ...
    { label: 'Email Officer', value: 'triptrek@gmail.com' },
  ],
};
